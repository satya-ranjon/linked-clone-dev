...
export default function PagesList() {
  return (
    <div className=" bg-white rounded-md">
      ...
      <div className="flex transition-all duration-300 justify-start cursor-pointer space-x-5 hover:bg-slate-100 p-5 py-4 border-t-2">
        <CgPlayListAdd className="my-auto text-2xl" />
        <p> Add new page</p>
      </div>
    </div>
  );
