...
export default function SugestFirendList() {
  return (
    <div className="bg-white my-4  text-neutral-900 ">
      <p className=" text-lg font-semibold p-3 mb-5 ">People you may know:</p>
      <div className="pl-2 p-5">
      ...
      <button className="w-full text-center p-2 border-t-2 ">See all</button>
    </div>
  );
}
