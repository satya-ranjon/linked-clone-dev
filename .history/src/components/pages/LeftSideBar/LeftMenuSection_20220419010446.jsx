...
export default function LeftMenuSection() {
  ...
  const deactiveStyle =
    "flex justify-start space-x-4 hover:bg-slate-100   p-4 py-3";
  return (
    <div className="text-xl text-[#666666] bg-white rounded-md  my-4 w-[278px] ">
      ...
      <NavLink
        to=""
        className="flex justify-start transition-all duration-300 space-x-4 hover:bg-slate-100 py-3 p-4"
      >
