  ...
  return (
    <div className="my-5 p-4 bg-white rounded-md">
      ...
      <div className="rounded-md overflow-hidden flex bg-[#F6F6F6]">
        ...
        />
        <MdOutlineKeyboardVoice className="my-auto text-2xl text-neutral-600 mx-1 cursor-pointer" />
        <BiImageAlt className="my-auto text-2xl text-neutral-600 mx-1 cursor-pointer " />
      </div>
    </div>
  );
}
