    ...
    <div className="my-5 p-4 bg-white rounded-md">
      ...
      <div className="rounded-md overflow-hidden flex bg-[#F6F6F6]">
        <Avatar
          ...
          alt="Remy Sharp"
          src="https://images.unsplash.com/photo-1644709298397-1df2795da69d?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=988&q=80"
