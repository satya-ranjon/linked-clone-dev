      ...
      <div className="mx-8 sm:mx-32 pt-20 text-center">
        ...
        <div className="grid place-items-center mt-40 space-y-4">
          ...
          <div className="p-0 ssm:p-8 py-10 ssm:w-96 bg-white space-y-3">
            ...
            <div className=" p-2 flex justify-center font-semibold text-lg space-x-3 cursor-pointer rounded-md hover:bg-neutral-200 transition-all duration-300 text-neutral-600  ">
              <p>Back</p>
            </div>
            <p>
              Already on LinkedIn?
