        ...
        <div className=" w-full ssm:w-96 sm:w-fit space-y-1 sm:p-4 sm:shadow-xl shadow-gray-800">
          ...
          <form className="pt-4">
            <div className="" onClick={() => setToggleOn(true)}>
              <label
                className={`font-normal transition-all duration-400  text-neutral-400 absolute p-2  ${
              ...
              <input
                ref={inputReff}
                type="text"
                className="border-[1px] border-gray-600 outline-[.5px] outline-blue-600 px-3 pt-4 p-1 w-full -z-10 "
              />
            </div>
