...
export default function Form() {
  ...
  return (
    <form className="pt-4 space-y-4">
      ...
      {pathname === "/signup" && (
        <div className=" p-2 flex justify-center font-semibold text-lg space-x-3 cursor-pointer rounded-md hover:bg-blue-600 transition-all duration-300 text-neutral-600  ">
          <p>Back</p>
        </div>
      )}
    </form>
