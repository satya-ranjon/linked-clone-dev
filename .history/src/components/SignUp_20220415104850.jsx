    ...
    <div className="m-10">
      ...
      <div className="grid place-items-center mt-6 z-10">
        <div className=" w-full sm:w-fit space-y-1 sm:p-4 sm:shadow-xl shadow-gray-800">
          ...
          <p className="font-semibold text-blue-600 cursor-pointer w-fit hover:bg-blue-200 transition-all duration-300 p-1 rounded-xl">
            Forget Password
          </p>
          <Button variant="contained" className="w-full rounded-xl p-5">
            Contained
          </Button>
        </div>
      </div>
