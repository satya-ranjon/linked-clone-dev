  ...
  return (
    <div className="m-10">
      ...
      <div className="grid place-items-center mt-6 ">
        <div
          className=" w-full ssm:w-96 sm:w-fit space-y-1 sm:p-4 sm:shadow-xl shadow-gray-800"
          ...
          <form className="pt-4">
            <div className="" onClick={() => setToggleOn(true)}>
              ...
              <input
                ref={inputReff}
                type="text"
                className="border-[1px] border-gray-600 outline-[.5px] outline-blue-600 px-3 pt-4 p-2 w-full bg-transparent "
              />
            </div>
            <div className="">
              <label onClick={onFocus}> Password</label>
              <input
                type="text"
