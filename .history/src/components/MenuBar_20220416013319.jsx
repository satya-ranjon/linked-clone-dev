...
export default function MenuBar() {
  const activeStyle =
    "text-green-600 border-b-[3px]  border-gray-600 transition-all duration-100";
  return (
    <div className="flex justify-between my-auto text-neutral-500 w-full pl-4 ssm:pl-10 ">
      <NavLink
        to="/home"
        className={(navInfo) =>
