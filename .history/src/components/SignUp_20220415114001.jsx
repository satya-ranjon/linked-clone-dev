      ...
      <div className="grid place-items-center mt-20 z-10">
        <div className=" w-full sm:w-[30rem] space-y-1 sm:p-4 sm:shadow-xl shadow-gray-800">
          ...
          <form className="pt-4 space-y-4">
            ...
            <div className="border-[1px] p-2 border-neutral-700 flex justify-center font-semibold text-lg space-x-3 cursor-pointer rounded-md hover:bg-neutral-200 transition-all duration-300">
