...
export default function MenuBar() {
  const activeStyle =
    "text-[#00ACFF] border-b-[3px]  border-[#00ACFF] transition-all duration-100 py-5 ";
  return (
    <div className="flex justify-between my-auto text-neutral-500 w-full pl-4 ssm:pl-8 ">
      <NavLink
        ...
        className={(navInfo) =>
          navInfo.isActive
            ? activeStyle
            : "border-b-[3px] border-transparent py-5 "
        }
      >
      ...
      <NavLink
        to="/friends"
        className={(navInfo) => (navInfo.isActive ? activeStyle : "py-5")}
      >
